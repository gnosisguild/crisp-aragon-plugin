...
interface IEnclave {
    ...
    function enableE3Program(IE3Program e3Program) external returns (bool success);
    ...
    function disableE3Program(IE3Program e3Program) external returns (bool success);
    ...
    /// @notice This function returns the count of inputs published for a given E3.
    /// @dev This function MUST revert if the E3 does not exist.
    /// @param e3Id ID of the E3.
