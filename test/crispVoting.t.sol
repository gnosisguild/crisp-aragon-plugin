...
contract MyPluginTest is TestBase {
    ...
    bytes crispProgramParams = "";
    bytes computeProviderParams = "0x7b226e616d65223a225249534330222c22706172616c6c656c223a66616c73652c2262617463685f73697a65223a347d";
    ...
    function test_CreateE3Request() external payable {
        ...
        plugin.createE3Request{value: 1}(
            ...
            abi.encode(
                uint256(0), 
                [uint256(block.timestamp), uint256(block.timestamp + 500)]
            )
        );
    }
}
